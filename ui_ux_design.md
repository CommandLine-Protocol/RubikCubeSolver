# Rubik's Cube Solver App -UI/UX Design
### 1. Design Goals
- Make the app easy to understand 
- Help users at each and every step
- Use visuals instead of long text
- Ensuring the app is easily accessible
### 2. Intended users
- People new at solving a rubik's cube
- Users who want a quick solution
- Students and puzzle fans 
...
- App resonds to every action
- Error messages are simple and helpful
